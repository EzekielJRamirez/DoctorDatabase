...
CREATE TABLE `patientcontact` (
  ...
  CONSTRAINT `patientcontact_ibfk_1` FOREIGN KEY (`PatientID`) REFERENCES `patient` (`PatientID`)
...
LOCK TABLES `patientcontact` WRITE;
/*!40000 ALTER TABLE `patientcontact` DISABLE KEYS */;
/*!40000 ALTER TABLE `patientcontact` ENABLE KEYS */;
UNLOCK TABLES;
